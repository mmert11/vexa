...
```bash
sudo apt install -y build-essential cmake ninja-build python3 python3-pip pkg-config libgmp-dev libmpfr-dev git curl meson 7zip libzstd-dev libtinfo-dev libxml2-dev zlib1g-dev

# optional, needed for testing pe files
