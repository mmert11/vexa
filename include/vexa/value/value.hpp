...
class value
{
  public:
    ...
    vexa::value *operator+(const value &rhs) const;
    vexa::value *operator-(const value &rhs) const;
    vexa::value *operator*(const value &rhs) const;
    vexa::value *operator/(const value &rhs) const;
    vexa::value *operator%(const value &rhs) const;
    ...
    vexa::value *operator>(const value &rhs) const;
    vexa::value *operator>=(const value &rhs) const;
    vexa::value *udiv(const value &rhs) const;
    vexa::value *urem(const value &rhs) const;
    vexa::value *lshr(const value &rhs) const;
    vexa::value *ult(const value &rhs) const;
    vexa::value *ule(const value &rhs) const;
    vexa::value *ugt(const value &rhs) const;
    vexa::value *uge(const value &rhs) const;
    vexa::value *concat(const value &rhs) const;
    vexa::value *extract(uint64_t high, uint64_t low) const;
    vexa::value *zext(uint64_t amount) const;
    vexa::value *sext(uint64_t amount) const;
    vexa::value *ite(const value &then_value, const value &else_value) const;
