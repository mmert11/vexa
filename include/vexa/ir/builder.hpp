...
{
public:
    builder(vexa::context* _context) : IRBuilder<>(*_context->llvm_context), context(_context), symex(context->symex) {};
    ...
    vexa::dual_value inttoptr(llvm::Value* v, llvm::Type* destTy, std::shared_ptr<vexa::mem_page> page);
